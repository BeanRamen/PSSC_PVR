            ...
            while (true)
            {
                ...
                switch (optiune)
                {
                    case "1":
                        ...
                        var variable = Console.ReadLine().Trim().ToLower();;
                        Console.WriteLine("A "+variable);
                        Action result = variable switch
                        {
                            "u" => () => 
                            {
                                Console.WriteLine("Am intrat in 'u'");
                            ...
                            "kg" => () =>
                            {
                                Console.WriteLine("Am intrat in 'kg'");
                            ...
                            _ => () =>
                            {
                                Console.WriteLine("Tip necunoscut! Te rog sa introduci 'u' pentru unitati sau 'kg' pentru kilograme.");
                            }
                        };
                        result();
                        break;
